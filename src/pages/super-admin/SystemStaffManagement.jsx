...
const SystemStaffManagement = () => {
  ...
  const filteredEmployees = allEmployees.filter((emp) =>
    selectedCinemaFilter === '' || String(emp.cinemaId) === String(selectedCinemaFilter)
  );
                    ...
                    <tr>
                      <td colSpan={6} className="text-center py-5 text-muted">
                        {selectedCinemaFilter
                          ? 'Không có nhân sự nào thuộc rạp này.'
                          : searchTerm
                        ...
                        <td className="text-center">
                          <div className="d-flex justify-content-center gap-2">
                            ...
                            <button
                              ...
                              title="Sửa"
                              onClick={() => navigate(`/super-admin/system-staff/edit/${emp.id}`)}
                            >Sửa</button>
                            <button
                              className="admin-btn admin-btn-sm admin-btn-danger"
                              title="Xóa"
                              onClick={() => { setDeletingItem(emp); setDeleteError(''); setShowDeleteModal(true); }}
                            >Xóa</button>
                          </div>
                        </td>
                      </tr>
            ...
            <div className="admin-modal-body">
              <div className="row">
                <div className="col-md-4 text-center">
                  <div
                    className="bg-light rounded-4 p-4 mb-3 d-flex align-items-center justify-content-center overflow-hidden"
                    style={{ height: '150px' }}
                  >
                    {selectedItem.avatar
                      ? <img src={selectedItem.avatar} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
